...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnonymousUserId.created'
        db.add_column('student_anonymoususerid', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnonymousUserId.created'
        db.delete_column('student_anonymoususerid', 'created')

"""
Library "Instructor Access" page in Studio
"""
...
class LibraryUsersPage(PageObject):
    """
    ...
    def url(self):
        """
        URL to the "Instructor Access" page for the given library.
        """
        return "{}/library/{}/team/".format(BASE_URL, unicode(self.locator))

    def is_browser_on_page(self):
        """
        Returns True iff the browser has loaded the library "Instructor Access" page.
        """
    ...
    def has_add_button(self):
        """
        Is the "Add Instructor" button present?
        """
